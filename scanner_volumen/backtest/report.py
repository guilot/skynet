...
def _aviso_metodologico(run: BacktestRun) -> list[str]:
    return [
        ...
        "  intercambiadas Y NEGADAS -no basta con intercambiarlas-. El filtro",
        "  de estado y dirección de la regla se aplica siempre sobre la señal",
        "  ORIGINAL -decide QUÉ señales se toman-; el fade solo cambia CÓMO",
        "  se opera cada una.",
